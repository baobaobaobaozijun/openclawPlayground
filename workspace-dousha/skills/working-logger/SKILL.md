...
**示例:**
```
20260311-232300-dousha-create-login-page.md
20260311-233000-dousha-fix-router-config.md
```
...
```bash
# 记录即将进行的修改
npx working-logger start --modifier "dousha" --description "创建登录页面"
```
...
```bash
# 完成修改，生成日志
npx working-logger complete --files "code/frontend/src/views/Login.vue,code/frontend/src/router/index.ts"
```
