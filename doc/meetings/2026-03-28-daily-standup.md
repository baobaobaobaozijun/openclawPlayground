...
1. **立即** - sessions_spawn 唤醒酱肉，分配 AuthController 任务
2. **立即** - sessions_spawn 唤醒豆沙，分配 auth.ts 任务
3. **立即** - sessions_spawn 唤醒酸菜，分配环境检查任务
4. **17:30** - 检查酱肉进度，验收 AuthController
5. **17:45** - 验收豆沙和酸菜任务
6. **18:00** - 执行 Plan-01 第 4 轮编译验证
