...
- **包子�?(Baozipu)** - 项目名称（博客业务系统）
- **OpenClaw** - 技术框架名称（Agent 协作框架�?- 包子铺项�?**使用** OpenClaw 框架来构�?
---

## 项目概述

包子铺是一个基�?OpenClaw 框架的多 Agent 协作软件开发平台。单�?OpenClaw Gateway 进程运行多个 Agent 实例，每�?Agent 拥有独立的工作空间，通过进程内通信实现高效协作�?
---
...
agent/
├── ARCHITECTURE.md
├── doc/                          # 统一知识�?�?  ├── 01-core/                  # 核心文档 (PRD/技术方�?执行清单)
�?  ├── 02-specs/                 # 规范文档
�?  ├── 03-guides/                # 使用指南
�?  ├── 05-progress/              # 进度跟踪 (心跳看板/项目仪表�?
�?  ├── 06-templates/             # 文档模板
�?  ├── 07-logs/                  # 日志索引
�?  ├── 08-knowledge/             # 知识�?�?  ├── guides/                   # Agent 专属指南
�?  └── meetings/                 # 站会纪要
├── workinglog/                   # 统一工作日志
�?  ├── guantang/
�?  ├── jiangrou/
�?  ├── dousha/
�?  └── suancai/
├── workspace-guantang/           # PM 工作�?├── workspace-jiangrou/           # 后端工作�?├── workspace-dousha/             # 前端工作�?├── workspace-suancai/            # 运维工作�?├── migration/                    # 迁移文档
├── status/                       # 状态文�?├── issues/                       # 问题追踪
└── _archived/                    # 归档目录
```
