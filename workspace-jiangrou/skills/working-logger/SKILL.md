...
**示例:**
```
20260311-232300-jiangrou-init-backend-api.md
20260311-233000-jiangrou-fix-auth-module.md
```
...
```bash
# 记录即将进行的修改
npx working-logger start --modifier "jiangrou" --description "开发用户认证 API"
```
...
```bash
# 完成修改，生成日志
npx working-logger complete --files "code/backend/api/auth.py,code/backend/models/user.py"
```
