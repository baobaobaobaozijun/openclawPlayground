# Agent 心跳监控机制 - v1 (Legacy)

**⚠️ 状态:** 🟡 **遗留版本** - 请使用 `agent-pipeline-mechanism-v3.md`
...
**请使用:** `doc/guides/agent-pipeline-mechanism-v3.md`

**v3 新增功能:**
- ✅ 数据库状态持久化（MySQL 6 张表）
- ✅ 自动恢复（系统重启后续做）
- ✅ 心跳监控 + Pipeline 双整合
- ✅ 审计追溯（pipeline_state_history 表）
...
| 恢复能力 | ❌ 手动 | ✅ 自动 |
| 查询速度 | 慢 | 快 |
| 与 Pipeline 整合 | ❌ 无 | ✅ 完全整合 |

---

**本文档保留作为历史参考，新机制请查看 v3 文档。**
