...
OpenClaw 是一个基于多 Agent 协作的软件开发平台，采用**配置与代码分离、工作台独立、容器化部署**的现代化架构设计。
...
1. **克隆仓库**
   ...
   # 各 Agent 工作台（包含核心配置）
   git clone https://github.com/baobaobaobaozijun/openclaw-backend.git agent/workspace-jiangrou
